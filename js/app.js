...
*/
    ...
    new Map([ [ "--font", [ "--font-weight", "--font-size" ] ], [ "--inset", [ "--inset-shadow", "--inset-ring" ] ], [ "--text", [ "--text-color", "--text-decoration-color", "--text-decoration-thickness", "--text-indent", "--text-shadow", "--text-underline-offset" ] ] ]);
    Map;
    function lt(r) {
        return {
            kind: "word",
    ...
    function chunk_3NGYYP5F_X(r, t, i = null) {
        for (let e = 0; e < r.length; e++) {
            let o = r[e], s = !1, l = 0, d = t(o, {
                parent: i,
                replaceWith(u) {
                    s || (s = !0, Array.isArray(u) ? u.length === 0 ? (r.splice(e, 1), l = 0) : u.length === 1 ? (r[e] = u[0], 
                    l = 1) : (r.splice(e, 1, ...u), l = u.length) : r[e] = u);
                }
            }) ?? 0;
            if (s) {
                d === 0 ? e-- : e += l - 1;
            ...
            if (d === 2) return 2;
            if (d !== 1 && o.kind === "function" && chunk_3NGYYP5F_X(o.nodes, t, o) === 2) return 2;
        }
    }
    function chunk_3NGYYP5F_H(r) {
        let t = "";
        ...
        for (let l = 0; l < r.length; l++) {
            ...
            switch (d) {
              ...
              case zt:
                {
                    ...
                    let u = l, f = l + 1;
                    for (;f < r.length && (s = r.charCodeAt(f), !(s !== Ot && s !== Pt && s !== jt && s !== _t && s !== Dt && s !== Ut && s !== It && s !== Ft && s !== zt)); f++) ;
                    l = f - 1;
                    let g = Hr(r.slice(u, f));
              ...
              case Qr:
                {
                    let u = l;
                    for (let f = l + 1; f < r.length; f++) if (s = r.charCodeAt(f), s === Kt) f += 1; else if (s === d) {
                        l = f;
                        break;
                    }
                    o += r.slice(u, l + 1);
    ...
    new Uint8Array(256);
    new Set([ "inset", "inherit", "initial", "revert", "unset" ]);
    function chunk_3NGYYP5F_Y(r, t) {
        if (t === null) return r;
        let i = Number(t);
    ...
    function ci(r, t, i, ...e) {
        ...
        if (s.startsWith("var(") || s.startsWith("theme(") || s.startsWith("--theme(")) {
            let d = chunk_3NGYYP5F_G(s);
            return mi(d, l), chunk_3NGYYP5F_H(d);
        }
        return s;
    }
    function di(r, t, i, ...e) {
    ...
    new RegExp(Object.keys(mt).map((r => `${r}\\(`)).join("|"));
    function pi(r) {
        if (r[0] !== "'" && r[0] !== '"') return r;
        let t = "", i = r[0];
    ...
    var st = (o => (o[o.None = 0] = "None", o[o.AtProperty = 1] = "AtProperty", o[o.ColorMix = 2] = "ColorMix", 
    o[o.All = 3] = "All", o))(st || {});
    var Te = (d => (d[d.None = 0] = "None", d[d.AtApply = 1] = "AtApply", d[d.AtImport = 2] = "AtImport", 
    d[d.JsPluginCompat = 4] = "JsPluginCompat", d[d.ThemeFunction = 8] = "ThemeFunction", 
    d[d.Utilities = 16] = "Utilities", d[d.Variants = 32] = "Variants", d))(Te || {});
...
*/
    ...
    function initSliders() {
        ...
        if (document.querySelector(".report__slider")) new swiper_core_Swiper(".report__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    const moreFaqBtn = document.querySelector(".more-questions");
    const faqBody = document.querySelector(".faq .spollers");
    moreFaqBtn?.addEventListener("click", (e => {
        faqBody.classList.toggle("show");
        moreFaqBtn.classList.toggle("more");
    }));
    gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
    gsapWithCSS.fromTo(".vertical-line", {
        height: 0
    }, {
        height: "100%",
        ease: "none",
    ...
    gsapWithCSS.fromTo(".horizontal-line", {
        width: 0
    }, {
        width: "50%",
        duration: .5,
    ...
    gsapWithCSS.fromTo(".vertical-line-bottom", {
        height: 0
    }, {
        height: "100%",
        ease: "none",
    ...
    gsapWithCSS.fromTo(".vertical-triangle-bottom", {
        scale: 0
    }, {
        scale: 1,
        ease: "back.out(1.7)",
    ...
    const steps = document.querySelectorAll(".anim-lines");
    steps.forEach(((step, index) => {
        ...
        tl.fromTo(step.querySelector(".line-1"), {
            scaleY: 0,
            transformOrigin: "top"
        }, {
            scaleY: 1,
            duration: .3
        }).fromTo(step.querySelector(".line-2"), {
            scaleX: 0,
            transformOrigin: "left"
        }, {
            scaleX: 1,
            duration: .3
        }).fromTo(step.querySelector(".line-3"), {
            scaleY: 0,
            transformOrigin: "top"
        }, {
            scaleY: 1,
            duration: .3
        }).fromTo(step.querySelector(".triangle"), {
            scale: 0,
            transformOrigin: "top"
        }, {
            scale: 1,
